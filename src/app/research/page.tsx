      ...
      <nav className="sticky top-0 z-50 bg-surface/95 backdrop-blur-sm border-b-2 border-border/80">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-6 text-sm font-bold">
            ...
            <Link href="/research" className="text-primary border-b-2 border-primary pb-0.5">Research</Link>
      ...
      <main>
        ...
        <section className="bg-gradient-to-b from-primary-dark to-primary text-white py-20 sm:py-28 border-b-4 border-primary-dark">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center relative z-10">
            <p className="text-amber-300 font-bold text-sm tracking-wide uppercase mb-4">Research</p>
            <h1 className="text-4xl sm:text-5xl font-extrabold leading-tight text-white tracking-tight">Grounded in evidence, transparent about assumptions</h1>
        ...
        <section className="py-20 sm:py-28 bg-gradient-to-br from-earth to-earth-light text-white">
          <div className="max-w-2xl mx-auto px-4 sm:px-6 text-center">
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/investors" className="btn-3d-saffron text-amber-950 font-extrabold shadow-[0_5px_0_#9a3412] px-8 py-4 text-lg">Investor Brief</Link>
              <Link href="/partners" className="btn-3d-white text-foreground shadow-[0_5px_0_var(--border-color)] px-8 py-4 text-lg">Partner with Us</Link>
            </div>
          </div>
        </section>
      </main>
